        ...
        47424: function(e, t, n) {
            ! function(e, t, n) {
                ...
                var c = ["animationData", "loop", "autoplay", "initialSegment", "onComplete", "onLoopComplete", "onEnterFrame", "onSegmentStart", "onConfigReady", "onDataReady", "onDataFailed", "onLoadedImages", "onDOMLoaded", "onDestroy", "lottieRef", "renderer", "name", "assetsPath", "rendererSettings"],
                    f = function(e, t) {
                        ...
                        var j = l(e, c),
                            ...
                            C = function() {
                                ...
                                if (L.current) {
                                    ...
                                    return R.current = o.default.loadAnimation(r), E(!!R.current),
                                        function() {
                                            var e;
                        ...
                        return n.useEffect(function() {
                            ...
                            if (R.current) {
                                ...
                                Array.isArray(m) && m.length && ((R.current.currentRawFrame < m[0] || R.current.currentRawFrame > m[1]) && (R.current.currentRawFrame = m[0]), R.current.setSegment(m[0], m[1]))
                            }
                    ...
                    d = function(e) {
                        ...
                        n.useEffect(function() {
                            var e, n, a, u, l, s = t.current;
                            if (s && r && i.length) switch (r.stop(), o) {
                                case "scroll":
                                    return e = null, n = function() {
                                            var t, n, o, a = (n = (t = s.getBoundingClientRect()).top, o = t.height, (window.innerHeight - n) / (window.innerHeight + o)),
                                                u = i.find(function(e) {
                                                    var t = e.visibility;
                                            ...
                                            if (u) {
                                                if ("seek" === u.type && u.visibility && 2 === u.frames.length) {
                                                    var l = u.frames[0] + Math.ceil((a - u.visibility[0]) / (u.visibility[1] - u.visibility[0]) * u.frames[1]);
                                ...
                                case "cursor":
                                    return a = function(e, t) {
                                            var n = e,
                                                o = t;
                                            if (-1 !== n && -1 !== o) {
                                                var a, u, l, c, f = (a = n, u = o, c = (l = s.getBoundingClientRect()).top, {
                                                    x: (a - l.left) / l.width,
                                                    y: (u - c) / l.height
                                                });
                                                n = f.x, o = f.y
                                            ...
                                            a(-1, -1)
                                        }, s.addEventListener("mousemove", u), s.addEventListener("mouseout", l),
                                        function() {
                ...
                Object.defineProperty(e, "LottiePlayer", {
                    ...
                    }, [null === (t = e.lottieRef) || void 0 === t ? void 0 : t.current]), m({
                        lottieObj: {
                            View: s,
                            play: c,
                            stop: d,
                ...
                }, e.useLottie = f, e.useLottieInteractivity = m, Object.defineProperty(e, "__esModule", {
                    value: !0
                })
            }(t, n(94840), n(2265))
        }
